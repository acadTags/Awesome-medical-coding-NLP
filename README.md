...
-[A Unified Review of Deep Learning for Automated Medical Coding](https://arxiv.org/abs/2201.02797) - a focus on deep learning and its main building blocks, specific for clinical coding as a healthcare AI application, in ACM Computing Surveys, 2024. (lastest version on [arxiv](https://arxiv.org/pdf/2201.02797v4)).
